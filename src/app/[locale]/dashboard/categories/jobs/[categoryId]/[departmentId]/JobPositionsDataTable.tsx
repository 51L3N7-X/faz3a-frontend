...
import { useJobPositionColumns } from "./columns";

type JobPositionsDataTableProps = {
  searchQuery?: string;
  parentId: number;
};

export function JobPositionsDataTable({ searchQuery = "", parentId }: JobPositionsDataTableProps) {
  ...
  const { columns } = useJobPositionColumns({
  ...
  const getNoResultsMessage = () => {
    if (searchQuery.trim()) {
      return "No job positions found.";
    }
    return "No job positions available.";
  };
