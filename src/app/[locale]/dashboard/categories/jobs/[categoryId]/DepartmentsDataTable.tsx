...
import { useDepartmentColumns } from "./columns";

type DepartmentsDataTableProps = {
  searchQuery?: string;
  parentId: number;
};

export function DepartmentsDataTable({ searchQuery = "", parentId }: DepartmentsDataTableProps) {
  ...
  const { subCategories, totalPages, isLoading, totalItems, isFetching } = useSubCategories(
    parentId,
    {
