...
import { useProfessionalCategoryColumns } from "./columns";

type ProfessionalsDataTableProps = {
  searchQuery?: string;
};

export function ProfessionalsDataTable({ searchQuery = "" }: ProfessionalsDataTableProps) {
  ...
  const { columns } = useProfessionalCategoryColumns({
  ...
  const getNoResultsMessage = () => {
    if (searchQuery.trim()) {
      return "No professional categories found.";
    }
    return "No professional categories available.";
  };
